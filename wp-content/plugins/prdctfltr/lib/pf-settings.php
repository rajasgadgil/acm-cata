	...
	?>
		...
		<tr valign="top">
			...
			<td class="forminp forminp-<?php echo sanitize_title( $field['type'] ) ?>">
				...
				<h3><?php _e( 'Filter Settings', 'prdctfltr' ); ?></h3>
				<p class="pf-desc">
					<?php echo __( 'Create filters! Greens are active, reds are not. Blue buttons add as many filters as you need! Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>'; ?>
				</p>
												...
												<td class="forminp forminp-select">
													<?php
														...
														$orderby_params = array(
															'' => __( 'None (Custom Menu Order)', 'prdctfltr' ),
															'id' => __( 'ID', 'prdctfltr' ),
			...
			if ( isset( $_GET['section'] ) && $_GET['section'] == 'register' ) {
				...
				$settings = array(
					'section_register_title' => array(
						...
						'type' => 'title',
						'desc' => __( 'By entering your purchase code you will enable the Automatic Updates option! Use one license per domain please! Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>',
					),
					'prdctfltr_purchase_code' => array(
						'name' => __( 'Register Product Filter', 'prdctfltr' ),
						'type' => 'text',
						'desc' => __( 'Enter your purchase code to get instant updated! Updates will come even before the Codecanyon.net official releases!', 'prdctfltr' ),
				...
				$settings = array(
					'section_analytics_title' => array(
						'name' => __( 'Product Filter Analytics', 'prdctfltr' ),
						'type' => 'title',
						'desc' => __( 'Follow your customers filtering data. BETA VERSION Please note, this section and its features will be extended in the future updates. Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>',
					),
				...
				$settings = array(
					'section_general_title' => array(
						'name' => __( 'Shop/Product Archives Installation Settings', 'prdctfltr' ),
						'type' => 'title',
						'desc' => __( 'General installation settings for Shop/Product Archive pages. Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>' . '<div id="prdctfltr_installation"></div>'
					),
					'prdctfltr_enable' => array(
						'name' => __( 'Shop/Product Archives Installation', 'prdctfltr' ),
						'type' => 'select',
					...
					'prdctfltr_enable_action' => array(
						'name' => __( 'Custom Action', 'prdctfltr' ),
						'type' => 'text',
						'desc' => __( 'Enter custom products action to initialize Product Filter template. Use actions from your theme archive-product.php template. Please enter action name in following format action_name:priority. E.G. woocommerce_before_shop_loop:40 woocommerce_archive_description:50', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_enable_action',
						'default' => 'woocommerce_archive_description:50',
						'css' => 'width:300px;margin-right:12px;'
					),
					'prdctfltr_default_templates' => array(
						'name' => __( 'Disable WooCommerce Templates', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Check this option to hide orderby.php and result-count.php templates. Works with the option below (Select Templates).', 'prdctfltr' ),
					...
					'section_advanced_title' => array(
						'name' => __( 'General - Advanced Settings', 'prdctfltr' ),
						'type' => 'title',
						'desc' => __( 'These settings will have an effect on both AJAX and NON-AJAX installations.', 'prdctfltr' )
					),
					'prdctfltr_custom_tax' => array(
						'name' => __( 'Use Characteristics', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Check this option to use Characteristics taxonomy.', 'prdctfltr' ),
...
/*					'prdctfltr_instock' => array(
					...
					'prdctfltr_use_variable_images' => array(
						'name' => __( 'Switch Variable Images', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Check this option to switch variable images when attribute filters are used.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_use_variable_images',
						'default' => 'no'
					),
					'prdctfltr_hideempty' => array(
						'name' => __( 'Hide Empty Taxonomy Terms', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Check this setting to hide empty taxonomy terms in options.', 'prdctfltr' ),
...
/*					'prdctfltr_taxonomy_relation' => array(
					...
					'section_ajax_title' => array(
						'name' => __( 'AJAX Shop/Product Archives - Advanced Settings', 'prdctfltr' ),
						'type' => 'title',
						'desc' => __( 'Set AJAX settings for Shop/Product Archive pages. AJAX shortcodes also need correct jQuery selectors to work properly. If your theme is good skip any jQuery Selector setting. For more information check the ', 'prdctfltr' ) . '<a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/#installation-sdgs" target="_blank">' . __( 'Specific Theme Installations', 'prdctfltr' ) . '</a>'
					),
					'prdctfltr_use_ajax' => array(
						'name' => __( 'Enable AJAX', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Check this option to use AJAX in Shop/Product Archive pages.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_use_ajax',
						'default' => 'no'
					),
					'prdctfltr_ajax_class' => array(
						'name' => __( 'Products Wrapper jQuery Selector (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_category_class' => array(
						'name' => __( 'Category jQuery Selector (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_product_class' => array(
						'name' => __( 'Product jQuery Selector (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_pagination_class' => array(
						'name' => __( 'Pagination jQuery Selector (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_pagination' => array(
						'name' => __( 'Custom Pagination Function (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_count_class' => array(
						'name' => __( 'Result Count jQuery Selector (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_orderby_class' => array(
						'name' => __( 'Order By jQuery Selector (AJAX)', 'prdctfltr' ),
						'type' => 'text',
					...
					'prdctfltr_ajax_columns' => array(
						'name' => __( 'Product Columns (AJAX)', 'prdctfltr' ),
						'type' => 'number',
						'desc' => __( 'This option should be used if theme returns wrong product columns after AJAX.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_ajax_columns',
						'default' => '',
						'css' => 'width:300px;margin-right:12px;'
					),
					'prdctfltr_ajax_rows' => array(
						'name' => __( 'Product Rows (AJAX)', 'prdctfltr' ),
						'type' => 'number',
						'desc' => __( 'This option should be used if theme returns wrong products per page after AJAX.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_ajax_rows',
						'default' => '',
						'css' => 'width:300px;margin-right:12px;'
					),
					'prdctfltr_pagination_type' => array(
						'name' => __( 'Pagination Type (AJAX)', 'prdctfltr' ),
						'type' => 'select',
						'desc' => __( 'Select pagination template to use in Shop/Product Archive pages.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_pagination_type',
						'options' => array(
							'default' => __( 'Default (In Theme)', 'prdctfltr' ),
							'prdctfltr-pagination-default' => __( 'Pagination (ONLY AJAX)', 'prdctfltr' ),
							'prdctfltr-pagination-load-more' => __( 'Load More (ONLY AJAX)', 'prdctfltr' ),
							'prdctfltr-pagination-infinite-load' => __( 'Infinite Load (ONLY AJAX)', 'prdctfltr' )
						),
						'default' => 'default',
						'css' => 'width:300px;margin-right:12px;'
					),
					'prdctfltr_product_animation' => array(
						'name' => __( 'Product Animation (AJAX)', 'prdctfltr' ),
						'type' => 'select',
					...
					'prdctfltr_after_ajax_scroll' => array(
						'name' => __( 'Scroll Animation (AJAX)', 'prdctfltr' ),
						'type' => 'select',
						'desc' => __( 'Select type of scroll animation after filtering.', 'prdctfltr' ),
					...
					'prdctfltr_ajax_permalink' => array(
						'name' => __( 'Permalink Structure (AJAX)', 'prdctfltr' ),
						'type' => 'select',
						'desc' => __( 'Set permalink structure when AJAX is used on Shop/Product Archive pages.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_ajax_permalink',
						'options' => array(
							'no' => __( 'Use Product Filter Redirects (Default)', 'prdctfltr' ),
							'query' => __( 'Only Add Query Parameters', 'prdctfltr' ),
							'yes' => __( 'Disable URL Changes', 'prdctfltr' )
						),
						'default' => 'no',
						'css' => 'width:300px;margin-right:12px;'
					),
					'prdctfltr_ajax_templates' => array(
						'name' => __( 'Disable Template Changes (AJAX)', 'prdctfltr' ),
						'type' => 'multiselect',
						'desc' => __( 'Select templates that will not change after AJAX (if supported).', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_ajax_templates',
						'options' => array(
							'title' => __( 'Title', 'prdctfltr' ),
							'desc' => __( 'Description', 'prdctfltr' ),
							'result' => __( 'Result Count', 'prdctfltr' ),
							'orderby' => __( 'Order By', 'prdctfltr' )
						),
						'default' => array(),
						'css' => 'width:300px;margin-right:12px;'
					...
					'prdctfltr_ajax_failsafe' => array(
						'name' => __( 'Failsafe Check (AJAX)', 'prdctfltr' ),
						'type' => 'multiselect',
					...
					'prdctfltr_ajax_js' => array(
						'name' => __( 'jQuery and JS Refresh (AJAX)', 'prdctfltr' ),
						'type' => 'textarea',
						'desc' => __( 'Enter jQuery or JavaScript code to execute after AJAX.', 'prdctfltr' ),
					...
					'section_noneajax_title' => array(
						'name' => __( 'NON-AJAX Shop/Product Archives - Advanced Settings', 'prdctfltr' ),
						'type' => 'title',
						'desc' => __( 'Setup advanced options for Shop/Product Archives when AJAX is disabled.', 'prdctfltr' )
					),
					'prdctfltr_force_redirects' => array(
						'name' => __( 'Permalink Structure', 'prdctfltr' ),
						'type' => 'select',
						'desc' => __( 'Set your permalinks structure.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_force_redirects',
						'options' => array(
							'no' => __( 'Use Product Filter Redirects (Default)', 'prdctfltr' ),
							'yes' => __( 'Use .htaccess and native WP redirects (Advanced)', 'prdctfltr' )
						),
						'default' => 'no',
						'css' => 'width:300px;margin-right:12px;'
					),
					...
					'prdctfltr_force_product' => array(
						'name' => __( 'Force Post Type Variable (Advanced)', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Option will add the ?post_type=product parameter when filtering.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_force_product',
						'default' => 'no'
					),
					'prdctfltr_force_action' => array(
						'name' => __( 'Force Stay on Permalink (Advanced)', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Check this option to force filtering on same permalink (URL).', 'prdctfltr' ),
				...
				if ( $action == 'get' ) {
					...
					printf( '<h3>%1$s</h3><p>%2$s</p><p>', __( 'Filter Preset Manager', 'prdctfltr' ), __( 'Manage your Product Filter presets. Save, load and manage unlimited filter presets! Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>' );
			?>
			...
			<?php
					...
					/*printf( '<p>%1$s: <span id="prdctfltr_slug_container">[prdctfltr_sc_products]</span></p>', __( 'To use selected preset in a products shortcode on Custom Pages use the following syntax.', 'prdctfltr' ) );*/
				...
				$settings = array(
					...
					'prdctfltr_adoptive_depend' => array(
						'name' => __( 'Select Adoptive Filtering Dependency', 'prdctfltr' ),
						'type' => 'select',
						'desc' => __( 'Adoptive filters can depend only on ceratin taxonomy.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_adoptive_depend',
						'options' => array_merge( array( '' => __( 'Default', 'prdctfltr' ) ), $ready_tax_clean ),
						'default' => '',
						'css' => 'width:300px;margin-right:12px;'
					),
					...
					'section_title' => array(
						'name'     => __( 'General Settings', 'prdctfltr' ),
						'type'     => 'title',
						'desc'     => __( 'Setup style and general settings. Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>'
					),
				...
				?>
					...
					<p><?php echo __( 'Override default filter preset on assigned taxonomy terms. Need help? Check this link', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/" target="_blank">' . __( 'Product Filter - Documentation and Guide', 'prdctfltr' ) . '</a>'; ?></p>
				<?php
