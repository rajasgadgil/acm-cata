...
<p id="asg-filters-style">
	<label><?php _e('Style', 'asg')?></label>
	<select name="asg[filters][style]">
		<option value="tabs" <?php selected($gallery['filters']['style'], 'tabs')?>><?php _e('Tabs', 'asg')?></option>
		<option value="dropdown" <?php selected($gallery['filters']['style'], 'dropdown')?>><?php _e('Dropdown', 'asg')?></option>
	</select>
</p>
