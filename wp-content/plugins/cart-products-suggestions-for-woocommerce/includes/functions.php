    ...
    function br_generate_product_selector($options) {
        ...
        $html = '<div class="br_search_box" data-function="' . $options['block_name'] . '" data-name="' . $options['name'] . '">
            <ul class="br_products_search">';
                ...
                $html .= '<li class="br_products_suggest_search"><input type="text" data-action="woocommerce_json_search_products_and_variations" class="br_search_input" placeholder="Enter 3 or more characters"></li>
            </ul>
        </div>';
        if( $options['return'] ) {
            return $html;
