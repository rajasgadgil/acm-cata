...
class GM_Migration {
	...
	private static $migrate_version_points = array(
		...
		'1.6.3.548'   => [ 'type' => 'ask' ], // rename woo_cart_dropdown_bg_color to woo_cart_dropdown_text_color.
		'1.7.0.619'   => [ 'type' => 'ask' ], // save meta field for nav_menu items to one field with json data.
		'1.8.0.658'   => [ 'type' => 'ask' ], // add default Mobile navigation menu item vertical padding.
		'1.9.2.753'   => [ 'type' => 'ask' ], // add default Desktop & Mobile z-index params.
	);
