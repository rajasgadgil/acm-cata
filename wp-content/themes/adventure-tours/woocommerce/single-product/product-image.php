...
<div class="images">
	<?php
		...
		if ( has_post_thumbnail() ) {
			...
			$html = sprintf( '<a href="%s" itemprop="image" class="woocommerce-main-image woocommerce-product-gallery__image--placeholder swipebox" title="%s">%s</a>',
				esc_url( $props['url'] ),
		...
		TdJsClientScript::addScript( 'initProductSwipebox', "jQuery('.woocommerce-main-image.swipebox[href!=\"#\"]').swipebox({useSVG: true, hideBarsDelay: 0, loopAtEnd: true});");
