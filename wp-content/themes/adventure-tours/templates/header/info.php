...
<div class="header__info">
	...
	<?php echo $left_html; ?>&nbsp;&nbsp;
	<i><?php get_template_part( 'templates/header/logo' ); ?></i> &nbsp;&nbsp;
	...
	<div class="header__info__items-right">
		...
		<?php get_template_part( 'templates/header/search' ); ?>
			<?php echo '<br>';?>
		<i class="fa fa-envelope-o"></i>&nbsp;<a href="https://acm-caraibes.com/contact/" style="color:#FFF;">Nous contacter</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<i class="fa fa-info-circle"></i>&nbsp;<a href="https://acm-caraibes.com/devis/" style="color:#FFF;">Un devis ?</a>
	</div>
</div>
