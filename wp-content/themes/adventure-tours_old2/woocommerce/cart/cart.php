					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-name">
							...
							<?php
								...
								if ( ! $product_permalink )
									echo apply_filters( 'woocommerce_cart_item_name', $_prod_name, $cart_item, $cart_item_key ) . '&nbsp;';
								else
									echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s">%s </a>', $_product->get_permalink( $cart_item ), $_prod_name ), $cart_item, $cart_item_key );
