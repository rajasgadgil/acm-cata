...
TdJsClientScript::addScript( 'initProductSwipebox', "jQuery('.woocommerce-main-image.swipebox[href!=\"#\"],.product-thumbnails .swipebox').swipebox({useSVG: true, hideBarsDelay: 0, loopAtEnd: true});");
